...
{\footnotesize
  \begin{center}
    \begin{longtable}{p{1.7cm}p{6.5cm}P{1.2cm}P{1.2cm}P{1.2cm}p{2.0cm}}
      ...
      \midrule
      Elnara Rustamzade \newline (co-advised with M. Pyrcz) & Data Science and Engineering-Based Uncertainty Modeling for Optimum Subsurface Reservoir Development & 5/2026 & PGE & UT Austin &  \\
...
\else
\begin{enumerate}
    \item Elnara Rustamzade PhD PGE 2026 \emph{co-advised with M. Pyrcz}
...
{\footnotesize
  \begin{center}
    \begin{longtable}{p{1.7cm}p{6.5cm}P{1.2cm}P{1.2cm}P{1.2cm}p{2.0cm}}
      \centering\textbf{Name} & \centering\textbf{Title} & \centering\textbf{Gradaution Date} & \centering\textbf{Program}  & \textbf{Institution} & \textbf{Placement} \\
      \midrule
      Amena Alelg & Development of a Fully Implicit Hydro-Mechanical Simulator Using the Enriched Galerkin Formulation & 5/2026 & PGE & UT Austin &  \\
...
\subsubsection*{MS}
\begin{enumerate}
    \item Saris Visessumon (PGE) \emph{co-advised with M. Pyrcz}
    \item Dursun Dashdamirov (PGE) \emph{co-advised with M. Pyrcz}
    \item Emmanuel Ekpesu (PGE) 
\end{enumerate}

\subsection*{Postdoctoral Researcher's Supervised}
  \begin{enumerate}
      \item Madison Schmitz, Ph.D. (UT)
